...
public class EventController {
    ...
    public ResponseEntity<List<EventDTO>> searchEventsUpComing(){
    ...
    public ResponseEntity<EventDTO> createEvent(@RequestBody EventDTO event,
                                                @RequestParam(value = "zoomCode", required = false) String zoomCode) {
        EventDTO eventDTO = eventService.createEvent(event, zoomCode);
