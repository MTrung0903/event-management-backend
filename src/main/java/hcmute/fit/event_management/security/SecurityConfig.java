    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    configuration.setAllowedOrigins(List.of("https://event-management-fontend-030c86383874.herokuapp.com/","https://event-recommendation-512c4c8777df.herokuapp.com", "https://event-management-server-asi9.onrender.com", "https://event-recommendation.onrender.com"));
